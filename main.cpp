...
void welcome()
{
	...
	for (int i = 0; i < 50; i++)
	{
		...
		cleardevice();
		settextstyle(i, 0, "楷体");
		outtextxy(x-80, y, "圣诞节前夜");
		outtextxy(x-10, y+100, "祝小月亮圣诞节快乐");
		Sleep(25);
	}
	...
	outtextxy(400, 200, "小月亮");
	outtextxy(400, 250, "虽然相隔甚远");
	outtextxy(400, 300, "但是，西西永远是那个西西");
	outtextxy(400, 350, "希望你一直开心  一直漂亮");
	outtextxy(400, 400, "西西嘴笨不会说话，不过西西一直在！");
	outtextxy(400, 450, "Merry Christmas Eve");
	outtextxy(600, 500, "----------西西");
